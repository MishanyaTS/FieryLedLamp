...
#elif defined(ESP32) && defined(CONFIG_IDF_TARGET_ESP32S3)
#define CLK 21  // Пин, подключенный к CLK на TM1637
#define DIO 18  // Пин, подключенный к DIO на TM1637
#define BUTTON_PIN 7  // Пин, подключенный к TTP223
